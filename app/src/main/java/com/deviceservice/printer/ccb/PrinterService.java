...
/**
 * Created by Panhaiting on 2017/12/12.
 * 打印驱动封装
 */
...
public class PrinterService {
    ...
    private OnPrintListener _printerListener = new OnPrintListener.Stub() {
        @Override
...
//    private OnPrintListener _tmplistener = ;
            ...
            if (status == ERROR_NONE) {
                ...
                try {
                    ...
                    alertDialog.setNeutralButton("取消", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            try {
                                _iPrinter.startPrint(new OnPrintListener.Stub() {
                                    @Override
                                    public void onFinish() throws RemoteException {
                                    }
     ...
     * @return
     */
    public PrinterService cutPaper() {
        try {
            _iPrinter.cutPaper();
            return this;
        } catch (RemoteException e) {
     ...
     * @return
     */
    public PrinterService autoCutPaper() {
        try {
            _iPrinter.autoCutPaper();
            return this;
        } catch (RemoteException e) {
            e.printStackTrace();
            return null;
